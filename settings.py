...
"""EDGE SERVERS"""
SHARE_OF_SERVERS = 0.18
USE_PEAK_BASED_PLACEMENT = True
...
SERVERS = [
    ...
    #    "MAX_POWER": 2336,
    #    "IDLE_POWER": 541,
    #    "MAX_CAPACITY": 332447660,
    #    "BOOT_TIME": 20,
    #},
    #{  # Sintético
    #    "MAX_POWER": 366,
    #    "IDLE_POWER": 107,
    #    "MAX_CAPACITY": 5052568,
    #    "BOOT_TIME": 20,
    #},
]
...
SERVICES = [
    ...
    #
    # CONNECTED VEHICLES
    Service("connected_vehicles", 7000, 10, 1600, 100, 5e-3),
    # AUGMENTED REALITY
    Service("augmented_reality",50000, 0.5, 700 * 1024, 10 * 1024, 20e-3),
    # VIDEO ANALYSIS
    Service("video_analysis", 30000, 6, 900 * 1024, 20, 100e-3),
]
